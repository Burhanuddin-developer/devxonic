  ...
  const blogPosts = [
    {
      ...
      title:
        "Mastering Multilingual Apps: Next.js Internationalization with Next-Intl",
      description:
        "Mastering Multilingual Apps: Next.js Internationalization with Next-Intl Introduction to Next.js Internationalization with Next-Intl In a…",
    ...
    },
    {
      ...
      description:
        "The Cost of Mobile Development in 2024: A Comprehensive Overview [iawp_view_counter] Introduction to Mobile Development…",
    ...
    },
    {
      ...
      description:
        "Handling Authentication and Authorization in Node.js [iawp_view_counter] Introduction In today’s world of web and mobile…",
    ...
    },
    {
      ...
      description:
        "The Biggest Challenges in IT and How to Overcome Them [iawp_view_counter] Introduction In the ever-evolving…",
    ...
    },
    {
      ...
      description:
        "Top Development Language Trends in IT You Need to Know in 2024 Introduction The IT…",
    ...
    },
    {
      ...
      category: "Web Development",
      title:
        "Understanding the Impact of Performance Testing on Application Success",
      description:
        "Understanding the Impact of Performance Testing on Application Success Introduction   Performance testing is an…",
