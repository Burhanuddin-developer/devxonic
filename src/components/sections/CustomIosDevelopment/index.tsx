      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-10 section-container">
        ...
        <div className="lg:col-span-2 space-y-8">
          <h1 className="text-3xl md:text-4xl font-bold">
            <span className="text-gray-400">Custom</span> iOS App{" "}
            <span className="text-white">Development</span>
          </h1>
          <p className="text-gray-300">
            We craft tailored iOS applications built to match your specific
            business goals, ensuring a unique and impactful user experience
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Our goal is to help you build apps that not only meet the high
              standards of Apple’s App Store but also provide a superior user
            ...
            <p className="text-gray-400 mt-6">
              Devxonic’s iOS App Development services are designed to help you
              create cutting-edge applications that stand out in the App Store
              and provide an exceptional experience for iOS users.
            </p>
          </div>
          <section className="mb-14">
            <h2 className="text-2xl font-bold mb-6">Service Benefits</h2>
            <p className="text-gray-300 mb-4 leading-relaxed">
              Choosing Devxonic for your iOS app development brings several key
              advantages:
            </p>
            <ul className="list-decimal pl-6 space-y-3 text-gray-300">
              <li>
                <strong>Native Excellence:</strong> Apps built using native
                technologies for superior performance and integration with iOS
                features.
              </li>
              <li>
                <strong>Intuitive Design:</strong>User-centric interfaces that
                align with Apple’s design principles for a seamless experience.
              </li>
              <li>
                <strong>Optimized Performance:</strong> Efficient coding and
                optimization for fast, reliable app performance.
              </li>
              <li>
                <strong>App Store Expertise:</strong> Support with App Store
                compliance and submission to ensure a smooth launch.
              </li>
            </ul>
            <p className="mt-8">Our iOS app development services are crafted to deliver high-quality applications that leverage the full potential
               of the iOS platform, helping you achieve your business goals and engage users effectively.</p>
          </section>
        </div>
