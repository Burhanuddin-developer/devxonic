...
export default function MobileApplication() {
  ...
  return (
      ...
      <Heading
          ...
          description="Explore our Mobile Applications projects that blend cutting-edge technology with creative solutions, delivering exceptional results tailored to your needs."
          className="max-w-2xl" />
